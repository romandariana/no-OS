ADIS16470 no-OS Example Project
===============================
...
The ADIS16470 is a precision, miniature microelectromechanical
system (MEMS) inertial measurement unit (IMU) that includes a triaxial
gyroscope and a triaxial accelerometer. Each inertial sensor in the ADIS16470
combines with signal conditioning that optimizes dynamic
performance.
...
The ADIS16470 eval devices have to be supplied with 3.3V voltage on VDD pin.
...
`Project Common Data Path <https://github.com/analogdevicesinc/no-OS/tree/main/projects/datax-imu-adis16470/src/common>`_

The macros used in Common Data are defined in platform specific files found in:
`Project Platform Configuration Path <https://github.com/analogdevicesinc/no-OS/tree/main/projects/datax-imu-adis16470/src/platform>`_

Basic example
^^^^^^^^^^^^^

This is a simple example which initializes the adis16470 selected device and
...
`Makefile <https://github.com/analogdevicesinc/no-OS/tree/main/projects/datax-imu-adis16470/Makefile>`_
...
This project is actually a IIOD demo for EVAL-ADIS16470 device series.
...
`IIO Trigger Example <https://github.com/analogdevicesinc/no-OS/tree/main/projects/datax-imu-adis16470/src/examples/iio_trigger_example>`_
...
ADIS16470 offers the capability to use DATA_READY pin as a flag which shows when
...
* `EVAL-ADIS16470 <https://www.analog.com/en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/EVAL-ADIS16470.html>`_ with
* `MAX78000 <https://www.analog.com/en/products/max78000.html>`_

**Connections**:

+---------------------------+----------+-------------------------------------------------------+---------------------+
| EVAL-ADIS16470 Pin Number | Mnemonic | Function                                              | MAX78000 Pin Number |
+---------------------------+----------+-------------------------------------------------------+---------------------+
